...
(* OASIS_START *)
(* DO NOT EDIT (digest: ac2816db146d71cb5a195a1baec355fd) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Forkhelpers"; "Fecomms"; "Fe"; "Restart"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "monitor.ml"});
               Executable
                 ({
                     cs_name = "fe_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "òîE;Þ\137\139l\146PÎï\141Æøs";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
